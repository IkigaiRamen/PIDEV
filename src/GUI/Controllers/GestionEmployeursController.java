...
public class GestionEmployeursController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try{
            ObservableList<User> list = FXCollections.observableArrayList(es.afficherEmployeurs());
    ...
    @FXML
    private void deleteEmployeur(ActionEvent event) throws SQLException  {
        e = table.getSelectionModel().getSelectedItem();
        if(!(e== null)){
            try{
                System.out.println(e);
                System.out.println(e.getId());
                es.supprimerUser(e.getId());
