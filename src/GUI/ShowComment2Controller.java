...
import GUI.Controllers.ListViewCommentaire;
 ...
 * @author 21627
 */
public class ShowComment2Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
         ...
         imv.setImage(new Image("images/" + p.getImage()));
          ...
          try {
            ...
            Logger.getLogger(ShowComment2Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    }    
    ...
    private void commenter(ActionEvent event) {
        ...
        c.setIdpost(Home2Controller.idE);
